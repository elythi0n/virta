...
const BUILT_IN_CATALOG: PluginInfo[] = [
  ...
  { id: 'virta.celebrations', name: 'Gifts',         description: 'Shoutout wall for subs, raids, gifts, and announcements.',                           built_in: true, state: 'enabled',  tags: ['events'],         version: '1.0.0', publisher: 'Virta' },
